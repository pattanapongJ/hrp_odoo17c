...
class SaleOrder(models.Model):
    ...
    def _get_herring_plus_footer_splitter(self):
        ...
        """
        self.ensure_one()
        lines = self._report_wrap_html_lines(self.other_template_text, HERRING_PLUS_OTHER_CHARS_PER_LINE)
        return self._report_paginate_lines(
            lines,
            HERRING_PLUS_FOOTER_LINES_PER_PAGE,
            first_page_reserved=HERRING_PLUS_FOOTER_INTRO_RESERVED_LINES,
        )
    ...
    def _get_herring_plus_total_page_count(self):
        ...
        """
        self.ensure_one()
        return self._get_herring_plus_footer_splitter().page_count

    def _get_herring_plus_other_page_lines(self, page_index):
        ...
        """
        self.ensure_one()
        return self._get_herring_plus_footer_splitter().page_text(page_index).split("\n")
